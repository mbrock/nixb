...
namespace nxb::cgroups
{
  ...
  constexpr std::array memory_stat_fields = {
    ...
    field_info{ "workingset_restore_file",
                ...
                field_info::unit_type::count },
    field_info{ "workingset_nodereclaim",
    ...
    field_info{ "pgscan_direct", "memory reclaim scan events (direct)",
                field_info::unit_type::count },
    field_info{ "pgsteal_kswapd",
                "memory reclaim eviction events (kswapd)",
                field_info::unit_type::count },
    field_info{ "pgsteal_direct",
  ...
  constexpr std::array cpu_stat_fields = {
    ...
    field_info{ "throttled_usec", "time spent throttled",
                field_info::unit_type::microseconds },
    field_info{ "nr_bursts", "burst periods",
                field_info::unit_type::count },
  ...
  constexpr std::array io_stat_fields = {
    ...
    field_info{ "wios", "write operations",
                field_info::unit_type::count },
    field_info{ "dbytes", "data discarded",
                field_info::unit_type::bytes },
    field_info{ "dios", "discard operations",
                field_info::unit_type::count },
  };
  ...
  std::map<std::string, stat_value>
  parse_cpu_stat (std::string_view contents)
  {
    std::map<std::string, stat_value> stats;
    std::istringstream file{ std::string (contents) };
    std::string line;
  ...
  parse_io_stat (std::string_view contents)
  {
  ...
  void
  print_field_rows (std::span<const field_info> fields,
