...
BOOST_DESCRIBE_ENUM (nix::ActivityType, actUnknown, actCopyPath,
                     actFileTransfer, actRealise, actCopyPaths, actBuilds,
                     actBuild, actOptimiseStore, actVerifyPaths, actSubstitute,
...
struct StartEvent
{
  ...
  std::optional<StoreRef> store_ref;
...
struct StopEvent
{
  ...
  std::string format (std::string_view type_name,
                      std::string_view activity_text, bool build_success,
